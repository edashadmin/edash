...
Only requiring some minor changes is edash.cpp.
...
Changes to edash.cpp
----------------------
edash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
