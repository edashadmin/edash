...
This mechanism has been integrated into Bitcore-Node-EDash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/edashpay/insight-api-edash#web-socket-api](https://github.com/edashpay/insight-api-edash#web-socket-api)
* API: [https://github.com/edashpay/insight-api-edash#instantsend-transactions](https://github.com/edashpay/insight-api-edash#instantsend-transactions)
...
By default, the EDash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EDash Core daemon:
