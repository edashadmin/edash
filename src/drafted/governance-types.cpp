...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EDashNetwork") type = EDashNetwork;
    if(strType == "EDashNetworkVariable") type = EDashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EDashNetwork) s = "EDashNetwork";
    if(type == EDashNetworkVariable) s = "EDashNetworkVariable";
