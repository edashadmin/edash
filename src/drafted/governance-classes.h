 ...
 *
 *   // network
 *   CEDashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.edash.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEDashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EDashNetwork
// //   -- signature requirements : Key1(User)
// class CEDashNetworkVariable : public CGovernanceObject
// {
// private:
