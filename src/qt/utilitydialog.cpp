    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("EDash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About EDash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  edash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the EDash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EDASH, 0.1 EDASH, 1 EDASH and 10 EDASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://edashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://edashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("EDash Core is shutting down...") + "<br /><br />" +
