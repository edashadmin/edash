    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EDASH-light"), QVariant("light"));
    ui->theme->addItem(QString("EDASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EDASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EDASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EDASH-traditional"), QVariant("trad"));
