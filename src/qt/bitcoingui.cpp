    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("EDash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EDash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and edash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About EDash Core"), this);
    aboutAction->setStatusTip(tr("Show information about EDash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EDash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EDash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EDash addresses"));
    ...
    openAction->setStatusTip(tr("Open a edash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EDash Core help message to get a list with possible EDash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("EDash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EDash network", "", count));
    } else {
...
{
    QString strTitle = tr("EDash Core"); // default title
