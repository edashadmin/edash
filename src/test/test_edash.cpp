...
#define BOOST_TEST_MODULE EDash Test Suite

#include "test_edash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_edash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
