...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all EDash related functionality
...
/*
    ...
    allow endless transaction that would bloat EDash and make it unusable. To
