/* src/config/edash-config.h.  Generated from edash-config.h.in by configure.  */
/* src/config/edash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EDASH_CONFIG_H

#define EDASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/edashpay/edash/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EDash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EDash Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "edashcore"
